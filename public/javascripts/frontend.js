...
window.socket = __webpack_require__(25)('http://localhost:3000');

Vue.component('tasks', __webpack_require__(51));
new Vue({
    el: "#app"
});
...
Component.options.__file = "C:\\Users\\Lil Essam\\Desktop\\app\\client-side\\components\\tasks.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3e4150c7", Component.options)
  } else {
    hotAPI.reload("data-v-3e4150c7", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  */
	mounted: function mounted() {
		...
		socket.on('connect', function () {
			socket.emit('channel', _this.channel);
		});
  ...
  */
   ...
   * @return void
   */
		markAsDone: function markAsDone(task_id) {
			var task = this.dbTasks.find(function (o) {
				return o._id == task_id;
			});
			if (task == undefined || task == null) {
				task = this.tasks.find(function (o) {
					return o._id == task_id;
				});
			}
			task.done = true;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('h2', [_vm._v(_vm._s(_vm.title))]), _vm._v(" "), _c('div', {
    staticClass: "row"
  }, [_c('input', {
    directives: [{
      name: "model",
  ...
  })]), _vm._v(" "), _vm._l((_vm.dbTasks), function(task) {
    return _c('div', {
      staticClass: "row"
    }, [_vm._v("\r\n    \t" + _vm._s(task.title) + " - " + _vm._s(task.done) + " "), (!task.done) ? _c('button', {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-3e4150c7", module.exports)
  }
}
